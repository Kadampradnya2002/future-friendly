...
load_bg = load_bg.resize((655,805))
...
button2 = tk.Button(base,text="... Press Button and Talk....",command=SPEECH,font=('Times New Roman',15,'bold'),width=20,bg='green',fg='white')
